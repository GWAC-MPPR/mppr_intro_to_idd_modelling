...
-   Deterministic models describe the average epidemic; stochastic models describe the range of possible epidemics, which matters most when the number of infected individuals is small.

-   The simplest stochastic SIR model treats each infection and recovery as a random event with the rate given by the ODE. Simulated many times, it shows that an outbreak started by a single case can die out by chance.
