...
- Compartmental models:
  - divide populations into compartments (or groups) based on the individual's [infection status]{style="color:tomato"} and [track them through time]{style="color:tomato"} [@Blackwood2018a].
