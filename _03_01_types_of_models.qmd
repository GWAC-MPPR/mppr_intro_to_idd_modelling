...
- Examples: compartmental models (SIR, SEIR), and agent-based models
:::
...
\- Can provide [biological insights]{style="color:blue"}

\- Allow testing of [intervention scenarios]{style="color:blue"}

\- Can extrapolate beyond observed data

\- Parameters often have [biological interpretation]{style="color:blue"}
:::
...
\- [Simpler]{style="color:blue"} to develop and implement

\- Good for [short-term predictions]{style="color:blue"}

\- Require [less detailed data]{style="color:blue"}

\- Computationally [efficient]{style="color:blue"}
:::
...
\- [Large populations]{style="color:blue"} (\>10,000)

\- Understanding [general trends]{style="color:blue"}

\- When computational [efficiency]{style="color:blue"} is important
:::
...
\- [Small populations]{style="color:blue"} (\<1,000)

\- [Early epidemic phases]{style="color:blue"}

\- [Uncertainty quantification]{style="color:blue"}

\- [Extinction events]{style="color:blue"}
:::
:::::
...
|---|---|---|
| **Mixing assumption** | [Homogeneous mixing]{style="color:blue"} | [Geographic structure]{style="color:orange"} |
| **Contact patterns** | [Equal contact]{style="color:blue"} probability | [Movement patterns]{style="color:orange"} |
| **Complexity** | Simpler | More complex |
| **Transmission** | Population-wide | [Local transmission]{style="color:orange"} |
| **Best for** | [Small, homogeneous]{style="color:blue"} populations | [Large-scale]{style="color:orange"} epidemics |

------------------------------------------------------------------------

### Common types of spatial models
...
- Account for [individual differences/heterogeneities]{style="color:orange"}
...
## Network models as a generic framework
...
::: {.column width="40%"}
![Examples of network models. Source: [Danon et al., 2010](https://doi.org/10.1155/2011/284909)](images/network_models.png)
:::
:::::
...
- Capture [realistic contact patterns]{style="color:blue"}
- Can model [targeted interventions]{style="color:blue"} (e.g., contact tracing)
- Account for [superspreading]{style="color:blue"} events
- Useful for [outbreak investigation]{style="color:blue"}
...
![Source: [Heesterbeek et al, 2015](https://doi.org/10.1126/science.aaa4339)](images/modelling_process.png){width="50%"}
...
Consider the case of modeling Ebola transmission in a small community in the DRC:
...
- [**Start simple**]{style="color:tomato"}: Keep the question at the forefront
