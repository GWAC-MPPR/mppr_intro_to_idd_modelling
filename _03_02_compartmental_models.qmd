...
- Compartmental models:
  - divide populations into compartments (or groups) based on the individual's [infection status]{style="color:tomato"} and [track them through time]{style="color:tomato"}.
  - are mechanistic, meaning they [describe processes]{style="color:tomato"} such as the interaction between hosts, biological processes of pathogen, host immune response, and so forth.
...
![Pathogen load and immune response after infection. Schematic after @keeling2008modeling.](images/infection_timeline.svg)
:::

::: {.content-visible when-format="pdf"}
![Pathogen load and immune response after infection. Schematic after @keeling2008modeling.](images/infection_timeline.pdf)
:::
:::
:::::
