...
- Generally, models can be used to [predict the future course]{style="color:tomato; font-weight:bold;"} and [understand/explain]{style="color:tomato; font-weight:bold;"} the dynamics of infectious diseases.
...
- [Accuracy]{style="color:tomato; font-weight:bold;"}: how well does the model [reproduce]{style="color:blue"} observed data and [predict]{style="color:blue"} future outcomes?
- [Transparency]{style="color:tomato; font-weight:bold;"}: is it [easy to understand and interpret]{style="color:blue"} the model and its outputs?
  - Affected by the [model's complexity]{style="color:tomato"}
- [Flexibility]{style="color:tomato; font-weight:bold;"}: the ability of the model to be [adapted to different scenarios]{style="color:blue"}.
...
How are the two model use cases (prediction and explanation/understanding) impacted by:

- accuracy,
- transparency,
- flexibility

That is, which of these factors is more important for each use case?
:::
...
![Milestones in mathematical modeling and modeling to inform public policy. Source: [Lesslar et al., 2016](https://doi.org/10.1093/aje/kww021)](images/model_milestones.png){width="75%"}
...
Given what you've learned so far, what do you think are some [limitations]{style="color:blue"} of infectious disease models?
:::
...
- Host [behaviour]{style="color:blue"} is often [difficult to predict]{style="color:blue"}.
- The pathogen often has [known/unknown characteristics]{style="color:tomato"} that are difficult to capture.
- [Data]{style="color:blue"} is often not available or is of poor quality:
  - Very rare to come across good quality ready to use data
