...
![Timeline of infection. Schematic after @keeling2008modeling.](images/infection_timeline.svg)
:::

::: {.content-visible when-format="pdf"}
![Timeline of infection. Schematic after @keeling2008modeling.](images/infection_timeline.pdf)
:::
...
- For complex models, we use the [next generation matrix]{style="color:tomato;"} approach.
...
- Modify the [`sir.qmd`](https://github.com/GWAC-MPPR/mppr_intro_to_idd_modelling_r_practicals/tree/main/model_implementation_practicals) script to simulate the SEIR model.
