...
- NPIs like isolation, social distancing and movement restrictions can reduce the transmission rate, $\beta$, by [reducing the contact rate]{style="color:tomato"} between susceptible and infectious individuals.
