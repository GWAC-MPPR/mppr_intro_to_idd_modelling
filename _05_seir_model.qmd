...
-   Modify the [`sir.qmd`](https://github.com/GWAC-MPPR/intro_to_idd_modelling_r_practicals/tree/main/model_implementation_practicals) script to simulate the SEIR model.
